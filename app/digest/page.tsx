    ...
    <>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 24px 40px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {/* ── SECTION 2: AI narrative placeholder ─────────────────────── */}
          <div
            style={{
              background: 'var(--bg-surface)',
          ...
          >
            ...
            {/* narrative content will replace this placeholder in a future update */}
            <p style={{ fontSize: 13, color: 'var(--text-tertiary)', fontStyle: 'italic', margin: 0, lineHeight: 1.6 }}>
              AI narrative generation is available when an ANTHROPIC_API_KEY is configured. This section will show a plain-English synthesis of this week&apos;s key findings.
            </p>
          </div>
